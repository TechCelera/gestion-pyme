...
import { ArrowUpRight, ArrowDownRight, TrendingUp, DollarSign, BarChart3, PieChart, Activity, Target, Zap } from 'lucide-react'
import {
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Resumen de la situacion de tu empresa</p>
      </div>
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="gastos" className="mt-4">
          <ChartCard icon={PieChart} title="Distribucion de Gastos" subtitle="Por categoria - Total: $875,000" gradient="from-[#FF6B6B] to-[#FFE66D]">
        ...
        <TabsContent value="flujo" className="mt-4">
          <ChartCard icon={Activity} title="Flujo de Caja Semanal" subtitle="Entradas vs salidas por dia" gradient="from-[#FF9F43] to-[#FF6B6B]">
            <ResponsiveContainer width="100%" height={350}>
