-- ============================================================================
-- RPC: nombre de contacto en listado y detalle (antes NULL::varchar placeholder)
-- ============================================================================
...
AS $$
  ...
  LEFT JOIN contacts ct ON ft.contact_id = ct.id AND ct.company_id = ft.company_id
...
COMMENT ON FUNCTION get_transactions IS 'Listado de movimientos con join a contacts para contact_name.';
COMMENT ON FUNCTION get_transaction_by_id IS 'Detalle de movimiento con join a contacts para contact_name.';
